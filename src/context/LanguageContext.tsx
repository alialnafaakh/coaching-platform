...
const UI_STRINGS: Record<Language, UiStrings> = {
  en: {
    ...
    select_date_info: "Select a date — today and future dates, while the time is still open",
  ...
  ar: {
    ...
    select_date_info: "اختر تاريخًا — اليوم والأيام القادمة طالما لم يبدأ الموعد بعد",
