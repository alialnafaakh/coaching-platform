        ...
        >
          ...
          <div className="p-8 md:p-12">
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8">
              ...
              <div>
                ...
                <div className="flex items-baseline gap-3 mb-2">
                  ...
                  <span
                    className="text-6xl font-semibold text-[#1a1a2e]"
                    style={{ fontFamily: "Cormorant Garamond, Georgia, serif" }}
                  >
                    $50
                  </span>
                ...
                {/* Discount badge */}
                <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold bg-[#d4a843]/15 text-[#9a7520] border border-[#d4a843]/30">
                  🔥 50% OFF — Limited Time Offer
                </span>

                <p className="mt-4 text-sm text-[#6b7280]">
                  40 minutes · Secure payment via Stripe
                </p>
              </div>
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center gap-4">
              <Link
                href="/book"
                className="w-full sm:w-auto text-center px-10 py-4 rounded-full text-base font-medium text-white shadow-lg hover:shadow-xl hover:scale-105 active:scale-95 transition-all duration-200"
                style={{ background: "linear-gradient(135deg, #0d7377, #14a3a8)" }}
              >
                Reserve My Spot →
              </Link>
              <p className="text-xs text-[#9ca3af] text-center">
                Secure checkout · No subscriptions · Cancel anytime
              </p>
            </div>
          </div>
